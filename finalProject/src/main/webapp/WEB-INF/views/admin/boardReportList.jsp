        ...
        <main>
            ...
            <section class="main-box">
                ...
                <section class="main-header">
                    <div>
                        <span class="show RPList" id="boardReportList">게시글</span>
                        <span class="noshow RPList" id="commentReportList">댓글</span>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach var="report" items="${reportBoardList}">
                                        <tr class="tRow">
                                            <td class="firstTd">${report.boardNo}</td>
                                            <td><div>${report.boardTitle}</div></td>
                                        ...
                                        <tr class="reportBoard tableSlide">
                                            <td colspan="5" >
                                                <span class="reportBoardTitle">
                                                    <div>
                                                        <h3>${report.boardName}</h3>
                                                        ${report.boardTitle}
                                                    </div>
                                                ...
                                                <span class="reportMS">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" class="finishReport" onClick="updateBoardReportSt(${report.boardNo}, this)">처리</button>
                                                    </div>
                                                </span>
                                            </td>
                                        </tr>
