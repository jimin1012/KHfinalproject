...
<body>
    ...
    <main id="boardFrm">
        ...
        <section class="boardTitleArea">
            <div class="titleF">
                <input type="text" name="boardTitle" id="boardTitleInput" placeholder="제목을 입력해 주세요." value="" maxlength="50">
            </div>
        </section>
        ...
        <section class="btnArea">
            <button class="btn11" id="insertBtn">작성</button>
        </section>
        
    </main>
    <jsp:include page="/WEB-INF/views/common/footer.jsp" />
	<script src="/resources/js/board/freeWrite.js"></script>
