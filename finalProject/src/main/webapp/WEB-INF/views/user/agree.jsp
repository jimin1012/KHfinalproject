    ...
    <main>
        <section class="container">
            ...
            <section class="signUp-content">
                ...
                <!-- 부제목 -->
                <div class="titleSub">
                    <p>약관동의<br><span>회원가입에 필요한 약관에 동의해주세요.</span></p>
                </div>
                ...
                <form action="/signUp" method="POST" class="signup-form">
                    ...
                    <div class="btn">
                        <button class="back-button" id="prev" onclick="history.back()">뒤로</button>
                        <button type="submit" class="next-button" id="result" onclick="location.href='/signUp'" disabled>다음</button>
                    </div>
                </form>
            </section>
        </section>
