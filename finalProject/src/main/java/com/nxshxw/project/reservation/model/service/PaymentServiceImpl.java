...
public class PaymentServiceImpl implements PaymentService{
	...
	@Override
	public void reservationCancle(String apikey, String secretkey, String token, String reservUID) throws IOException  {
	        ...
	        // JSON 객체에 해당 API가 필요로하는 데이터 추가.
	        JsonObject json = new JsonObject();
	        json.addProperty("imp_uid", reservUID);
	        json.addProperty("reason", "테스트결제취소");
