...
//    private final String uploadDir = Paths.get("C:", "tui-editor", "upload").toString();
    ...
    private String webPath = "/resources/images/board/";
    /**
     * 에디터 이미지 업로드
     * @param image 파일 객체
     * @return 업로드된 파일명
    ...
    public String uploadEditorImage(@RequestParam final MultipartFile image
        ...
        String fileFullPath = Paths.get(filePath, saveFilename).toString();                      // 디스크에 저장할 파일의 전체 경로

        // filePath에 해당되는 디렉터리가 없으면, filePath에 포함되는 전체 디렉터리 생성
